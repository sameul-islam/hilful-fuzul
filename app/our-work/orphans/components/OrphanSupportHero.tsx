...
import orphanHero from '@/public/orphan-hero.jpg';

export default function OrphanSupportHero() {
  return (
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <h1 className="text-3xl md:text-5xl lg:text-4xl xl:text-5xl font-bold leading-tight text-gray-900">
            এতিম শিশুদের পাশে দাঁড়ানো আমাদের দায়িত্ব
          </h1>

          <p className="mt-6 text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
            সমাজে অনেক শিশু রয়েছে যারা পিতামাতার স্নেহ ও নিরাপত্তা থেকে বঞ্চিত।
            আমরা তাদের জন্য শিক্ষা, খাদ্য, চিকিৎসা এবং একটি নিরাপদ ভবিষ্যৎ
            নিশ্চিত করার চেষ্টা করি। আপনার সহায়তায় একটি শিশুর জীবন
            নতুন আশায় ভরে উঠতে পারে।
          </p>
